...
public class BookingJournal {
	...
	public BookingJournal(String room, int price, int rooms, int persons, int children, String openBuffet,
	...
	public String toString() {
		return "Reservation [id=" + reservation + ", room=" + room + ", price=" + price + ", rooms=" + rooms + ", persons="
